...
//
// 用法:
//   node tools/build/vendor-opencc.mjs <path-to-extracted-opencc-js-package>
...
if (!pkgDir) {
  console.error('用法:node tools/build/vendor-opencc.mjs <path-to-extracted-opencc-js-package>');
  process.exit(1);
}
