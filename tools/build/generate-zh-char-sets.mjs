...
//
// 用法:node tools/build/generate-zh-char-sets.mjs(dict 已 vendor 在 repo,直接可跑)
...
const BEGIN = '// ── GENERATED:ZH-CHAR-SETS BEGIN(tools/build/generate-zh-char-sets.mjs,勿手改)──';
