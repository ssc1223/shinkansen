...
//
// 用法:
//   node tools/harness/pdf-layout-snapshot.js              # check(預設):跑全部 + 列 diff,有 diff 退 1
//   node tools/harness/pdf-layout-snapshot.js --update     # 用當前結果覆寫 snapshot 為 baseline
//   node tools/harness/pdf-layout-snapshot.js --metrics    # 印 cross-PDF 結構 metrics 表(不寫 snapshot)
//   node tools/harness/pdf-layout-snapshot.js --only Plano # 只跑檔名含 Plano 的 PDF
//
